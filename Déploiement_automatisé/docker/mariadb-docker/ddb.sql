...
INSERT INTO `objets` VALUES (1,1,'Prise2','false','CONSO','192.168.1.154'),(2,2,'Ventilo','true','CONSO','192.168.1.164'),(3,1,'Prise1','true','CONSO','Prise1'),(4,1,'Prise_shelly0','true','CONSO','192.168.1.128,0'),(5,1,'Prise_shelly1','true','CONSO','192.168.1.128,1'),(6,1,'Onduleur','true','PROD','192.168.1.157'),(7,1,'esp1','true','CONSO','192.168.1.111'),(8,1,'eMylo1','true','CONSO','eMylo1');
...
/*!50003 DROP PROCEDURE IF EXISTS `ADD_objet` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `ADD_objet`(
	IN `_idMaison` INT,
	IN `_nom` VARCHAR(50),
	IN `_etat` VARCHAR(50),
	IN `_type` VARCHAR(50),
...
BEGIN
	INSERT INTO objets (ID_MAISON, NOM , ETAT,TYPE, IP ) VALUES ( _idMaison, _nom, _etat, _type, _ip);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-02-12 15:16:13
